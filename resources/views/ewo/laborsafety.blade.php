...
<div class="container bg-grey collapse" id="laborsafety" name="divpage">
    ...
    <div class="card w-100 mb-3">
        ...
        <div class="collapse show">
            <div class="card-body col-3">
                <img class="" width="500"
                     id="img_lsImg" src="/ewo_lsImg/{{ date('Ym') }}/{{ date('Ymd') }}/lsImg_{{ date('Ymd') }}_{{ $p_data['userId'] }}.jpg?i={{date('His')}}"
