    ...
    <tr>
        <td class="col-3" >
            @if(!empty($data['TWMBB']['head_logo_img']))
                <img src="{{ $data['TWMBB']['head_logo_img'] }}" width="150">
            @endif
        </td>
        <td class="col-6 text-center">
            <p class="m-0 font-s30">{{ $data['TWMBB']['head_title01'] }}</p>
            <p class="m-0 font-s20">{{ $data['TWMBB']['head_title02'] }}</p>
        </td>
        <td class="col-3 text-center">
            <img src="{{ $data['TWMBB']['logo_url_fet'] }}" width="130" height="40">
        </td>
    </tr>
</table>
...
<table id="table101">
    <tr>
        <td colspan="7" class="col-12 wordWrap h-70p">
            <p class="m-0 text-top font-s15 mt-1 mb-4 line-h10">此致 遠傳電信股份有限公司</p>

            <p class="m-0 text-bot font-s10 line-h08">
                申裝人(簽名):@if(!empty($data['TWMBB']['signImage'])) <img src="{{ $data['TWMBB']['signImage'] }}" height="50px"> @endif
